...
# Redesigned By - @bipuldey19 (https://t.me/mirror_247_chennel)
...
<body>
  <!--© Designed and coded by <©--->
    <header>
      <div class="©">
        <img
          src="http://direct-cyber.herokuapp.com/download/483"
          alt="logo"
        />
        <a href="https://t.me/mirror_247_chennel"> 
          <h2 class="name">24/7-mirrorbot</h2>
        </a>
      </div>
      <div class="group">
        <a href="https://t.me/mirror_247_chat"><i class="fab fa-telegram"></i></a>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See 24/7-mirrorbot <a href='https://t.me/mirror_247_chennel'>@GitHub</a> By <a href='https://t.me/mirror_247_chennel'>24/7 Mirror</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>24/7-mirrorbot</h3>", content_type="text/html")
            return response
